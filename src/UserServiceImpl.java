...
public class UserServiceImpl extends UnicastRemoteObject implements UserService {
    ...
    public UserServiceImpl() throws RemoteException, SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
        super();
    ...
    @Override
    public void insertGame(String gameId, String winner, int duration) throws RemoteException {
        db_conn.insertGames(gameId, winner, duration);
    }

    @Override
    public void insertUserToGame(String user, String gameId) throws RemoteException {
        db_conn.insertUserToGame(user, gameId);
    }
}